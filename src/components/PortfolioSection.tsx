...
const PortfolioSection = () => {
  ...
  return (
    <section id="portfolio" className="py-24 md:py-32 px-4">
      <div className="container mx-auto">
        <div className="text-center mb-16">
          <h2 className="font-display text-3xl md:text-4xl lg:text-5xl font-bold mb-4">
            Our <span className="text-secondary">Projects</span>
          </h2>
          <p className="text-muted-foreground max-w-xl mx-auto text-lg">{t('portfolioSubtitle')}</p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {projects.map((p, i) => (
            <div
              key={i}
              className="glass rounded-2xl overflow-hidden group hover:border-secondary/30 hover:-translate-y-2 transition-all duration-500"
            >
